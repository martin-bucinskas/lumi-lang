...
impl VirtualMachine {
  pub fn arithmetic_execute_add(&mut self) {
  ...
  pub fn arithmetic_execute_sub(&mut self) {
    let first_byte = self.next_8_bits();
    let second_byte = self.next_8_bits();
    let third_byte = self.next_8_bits();
  ...
  pub fn arithmetic_execute_mul(&mut self) {
    let first_byte = self.next_8_bits();
    let second_byte = self.next_8_bits();
    let third_byte = self.next_8_bits();
  ...
  pub fn arithmetic_execute_div(&mut self) {
    let first_byte = self.next_8_bits();
    let second_byte = self.next_8_bits();
    let third_byte = self.next_8_bits();
  ...
  pub fn arithmetic_execute_add_f64(&mut self) {
  ...
  pub fn arithmetic_execute_sub_f64(&mut self) {
    let register_1 = self.float_registers[self.next_8_bits() as usize];
    let register_2 = self.float_registers[self.next_8_bits() as usize];
  ...
  pub fn arithmetic_execute_mul_f64(&mut self) {
    let register_1 = self.float_registers[self.next_8_bits() as usize];
    let register_2 = self.float_registers[self.next_8_bits() as usize];
  ...
  pub fn arithmetic_execute_div_f64(&mut self) {
    let register_1 = self.float_registers[self.next_8_bits() as usize];
    let register_2 = self.float_registers[self.next_8_bits() as usize];
  ...
  pub fn arithmetic_execute_increment(&mut self) {
  ...
  pub fn arithmetic_execute_decrement(&mut self) {
    let register = self.next_8_bits() as usize;
